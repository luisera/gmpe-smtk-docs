...
OpenQuake Ground Motion Tookit - User Guide\par % Book title
\endgroup
...
\noindent
   ...
   Weatherill, G. A., Pagani, M., Monelli, D. and Garcia, J. (2014) OpenQuake Ground Motion Toolkit - User Guide. \textit{Global Earthquake Model (GEM). Technical Report}\\
   \hfill \\
\noindent 
   {\bf{Disclaimer}} \hfill \\
   The ``OpenQuake Ground Motion Toolkit - User Guide'' is distributed in the hope that it will be useful, but without any warranty: without 
